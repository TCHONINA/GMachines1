...
<script src="jquery/machines.js" type="text/javascript"></script>
</head>
<body>
						...
						<div class="card">
							...
							<div class="card-body">
								<form action="#" id="step-form-horizontal"
											...
											<div class="row">
												<div class="col-lg-6 mb-4">
													<div class="form-group">
														<label class="text-label">Réference</label> <input
															type="text" name="firstName" id="ref"
												...
												<div class="col-lg-6 mb-4">
													<div class="form-group">
														...
														<input
															type="text" id="marque" name="lastName"
															class="form-control" required>
													</div>
												</div>
												...
												<div class="col-lg-6 mb-4">
													<div class="form-group">
														<label class="text-label">Date d'achat</label> <input
												...
												<div class="col-lg-6 mb-4">
													<div class="form-group">
														<label class="text-label">Prix d'achat</label> <input
															type="number" id="prix" name="phoneNumber"
															class="form-control" required>
												...
												<div class="col-lg-12 mb-4">
													<div class="form-group">
														<label class="text-label">Salle</label> <select
															class="form-control" id="salle"></select>
													</div>
												</div>
									...
									<button type="button" id="ajouter" class="btn btn-primary  "
										style="float: right;">Ajouter</button>
